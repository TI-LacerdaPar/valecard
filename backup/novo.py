...
#             sql = """
#                 INSERT INTO dbo.Endereco (estado, bairro, cidade, endereco, data)
#                 VALUES (?, ?, ?, ?, ?)
#             """
...
#     logging.info(f"{enderecos_inseridos} registros foram inseridos na Tabela Endereco com sucesso")


# salvar motoristas

# def salvar_dados_motoristas(dados):

#     conn = conectar_banco()
#     cursor = conn.cursor()

#     cursor.execute("""
#     IF OBJECT_ID(N'dbo.Motoristas', N'U') IS NULL
#     BEGIN
#         CREATE TABLE dbo.Motoristas (
#             motorista_id INT IDENTITY(1,1) PRIMARY KEY,
#             cpfMotorista NVARCHAR(20),
#             motorista NVARCHAR(200),
#             motorista_data DATETIME
#         )
#     END
#     """)
...
#             sql = """
#             INSERT INTO dbo.Motoristas (cpfMotorista,motorista, motorista_data)
#             VALUES (?, ?, ?)
#             """
...
#         except Exception as e:
#             logger.error(f"Erro ao inserir motorista: {e}")

#     conn.commit()
#     conn.close()

#     logger.info(f"{registros} registros inseridos na tabela Motoristas com sucesso")
...
#             data DATETIME,
#             numeroFrota NVARCHAR(255),
#             placa NVARCHAR(20),
#             modelo NVARCHAR(200),
#             hodometro NVARCHAR(50),
...
#             centroResultadoVeiculo NVARCHAR(200),
#             numeroCartao NVARCHAR(50),
#             responsavel NVARCHAR(100),
#             tipoFrota NVARCHAR(100),
#             cnpj NVARCHAR(100),
#             tipoServico NVARCHAR(50),
#             produtoId NVARCHAR(50),
#             id NVARCHAR(50),
#             centroCusto NVARCHAR(255),
#             codigo NVARCHAR(100),
#             classificacaoContabil NVARCHAR(255),
#             codigoTerminal NVARCHAR(255),
#             endereco_id INT,
#             motorista_id INT,
...
#                 nomeFantasia, telefone, produto, quantidade,
...
#                 cnpj, tipoServico, produtoId, id,
#                 centroCusto, codigo, codigoTerminal
#             )
#             VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
#             """
...
def salvar_dados_gastos(dados):
    ...
    BEGIN
        CREATE TABLE dbo.Gastos (
            ...
            cpfMotorista VARCHAR(50),
            produtoId NVARCHAR(50),
            id NVARCHAR(50),
            centroCusto NVARCHAR(255),
            codigo NVARCHAR(100),
            classificacaoContabil NVARCHAR(100),
            codigoTerminal NVARCHAR(100),
    ...
    for item in dados:
        ...
        try:
            ...
            nomeFantasia, estado, telefone, produto, quantidade,
            valorUnitario, valorTotal, limiteCredito,
            saldoAtual, distancia, consumo, unidade,
            reaisPorKm, filialVeiculo, centroResultadoVeiculo,
            numeroCartao, responsavel, tipoFrota,
