...
# pegar as data atuais

#API_URL = os.getenv("API_URL")
# API_BODY = {
#     "contratoCliente": "136768",
#     "dataInicial": "2026-01-01",
#     "dataFinal": "2026-01-28",
#     "tipotransacao": "TODAS"
# }
...
def salvar_dados_gastos(dados):
        ...
        try:
            ...
            sql = """
                INSERT INTO Gastos (
                    ...
                    cpfMotorista, ID_produto, ID_API, centroCusto, codigo, codigoTerminal
                )
                VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
            """
    ...
    logging.info(f"{registros_atualizados} registros inseridos no banco")
...
def  salvar_dados_motorista(dados):
    ...
    # salvar os dados da tabela para salvar todos
...
def salvar_dados_todos(dados):
    ...
    logging.info(f"{registros_atualizados} registros foram inseridos com sucesso")
